...
;
SCCENABLE	.EQU	FALSE		; SCC: ENABLE Z85C30/85230 SERIAL DRIVER (SCC.ASM)
SCC0BASE	.EQU	$A0		; SCC 0: BASE ADDRESS OF CHIP
...
;
PPAENABLE	.EQU	FALSE		; PPA: ENABLE IOMEGA ZIP DRIVE (PPA) DISK DRIVER (PPA.ASM)
...
;
IMMENABLE	.EQU	FALSE		; IMM: ENABLE IOMEGA ZIP PLUS DRIVE (IMM) DISK DRIVER (IMM.ASM)
...
;
SYQENABLE	.EQU	FALSE		; SYQ: ENABLE SYQUEST SPARQ DISK DRIVER (SYQ.ASM)
